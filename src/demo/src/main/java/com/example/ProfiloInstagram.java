...
public class ProfiloInstagram 
{
    //driver per muoversi - utili per tutto
    protected WebDriver driver_profile;
    protected JavascriptExecutor js;
    protected WebDriverWait wWait;

    //nome profilo e altre variabili essenziali
    protected String nomeProfilo;
    protected String id;
    protected String password;
    protected List<String> followerArray;
    protected List<String> seguitiArray;
    protected List<WebElement> listaFollowers;
    protected List<WebElement> listaSeguiti;

     
    public ProfiloInstagram(ChromeOptions options) {

        this.driver_profile = new ChromeDriver(options);
        this.js = (JavascriptExecutor) this.driver_profile;
        this.wWait = new WebDriverWait(this.driver_profile, Duration.ofSeconds(20));
        ...
        this.id = "gatto_miele99";
        this.password = "Lorenzo_99";
      }



   protected void accediConDati()
   {
      this.wWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//input[@name='username']"))).sendKeys(id);
      this.wWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//input[@name='password']"))).sendKeys(password);
      this.wWait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[contains(text(),'Accedi')]"))).click();
   }   
   

   protected void vaiSuInstagram()
   {
